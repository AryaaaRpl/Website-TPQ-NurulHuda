...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-4">
        <div class="w-14 h-14 rounded-full bg-emerald-100 flex items-center justify-center text-xl font-bold text-emerald-600 overflow-hidden shrink-0 border-2 border-emerald-200">
            @if ($admin->avatar)
                <img src="{{ $admin->avatar }}" alt="" class="w-full h-full object-cover">
            @else
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm mt-0.5">Selamat datang kembali, {{ $admin->name }}.</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 sm:p-6">
    ...
    <div class="flex flex-col sm:flex-row flex-wrap gap-3 mt-5">
        ...
        <a href="{{ route('admin.settings.edit') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition sm:w-auto">
